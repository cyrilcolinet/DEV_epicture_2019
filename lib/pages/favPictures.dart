...
import 'package:epicture/objects/FavImage.dart' as object;
...
class _FavPicturesState extends State<FavPictures> {
  bool loaded = false;
  List<object.FavImage> images = [];
  List<TileSize> tileSizes = [];

  Future<List<object.FavImage>> parseAccountPictures() {
    Future request = getRequest("/account/me/gallery_favorites/", "data");

    return request.then((data) {
      List<object.FavImage> tmpImages = [];
